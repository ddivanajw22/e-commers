       ...
       <aside class="w-52 flex-shrink-0 font-42dot">
        ...
        <main class="flex-1">
            <div class="flex justify-end mb-10">
                <form action="{{ route('shop.bottom') }}" method="GET" class="relative w-72">
            ...
            <div class="grid grid-cols-3 gap-x-12 gap-y-16">
                ...
                @empty
                    <div class="col-span-3 text-center py-10">
                        ...
                        <a href="{{ route('shop.bottom') }}" class="text-black underline mt-2 block">Reset Pencarian</a>
                    </div>
                @endforelse
            </div>
        </main>
