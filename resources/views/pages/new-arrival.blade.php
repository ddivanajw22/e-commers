...
<div class="px-[8%] flex gap-12 pt-10">
    ...
    <aside class="w-52 flex-shrink-0 font-42dot">
        ...
        <ul class="relative ml-[7px]">
            ...
            <li class="relative py-[6px] pl-5">
                ...
                <a href="{{ $url }}" class="text-[13px] text-gray-500 hover:text-black transition-colors block">
                    {{ $label }}
                </a>
            </li>
            @endforeach
        ...
        <ul class="mt-10 text-[13px] space-y-4 text-gray-500 border-t pt-8">
            <li>
                <a href="{{ route('shop.new-arrival') }}" class="block font-bold text-black">
                    New Arrival
                </a>
            </li>
            <li>
                <a href="{{ route('shop.best-seller') }}" class="hover:text-black block">
                    Best Seller
                </a>
            </li>
            <li>
                <a href="{{ route('shop.on-discount') }}" class="hover:text-black block">
                    On Discount
                </a>
            </li>
        </ul>
    ...
    <main class="flex-1">
        <h2 class="text-xl font-bold mb-6">New Arrival</h2>
