    ...
    <div class="px-[8%] flex gap-12 pt-10">
        ...
        <aside class="w-52 flex-shrink-0 font-42dot">
            ...
            <ul class="text-[13px] space-y-4 text-gray-500">
                ...
                <li>
                    <a href="/shop" class="text-gray-800 hover:text-black cursor-pointer">
                        All Product
                    </a>
                </li>
                ...
                <li class="relative pl-5 flex items-center gap-2 before:content-[''] before:absolute before:left-[7px] before:top-[-10px] before:bottom-2 before:w-[1px] before:bg-gray-300">
                    ...
                    <a href="/shop" class="font-bold text-black border-b-2 border-black">
                        Tops
                    </a>
                ...
                <li class="relative pl-5 flex items-center gap-2 before:content-[''] before:absolute before:left-[7px] before:top-[-10px] before:bottom-2 before:w-[1px] before:bg-gray-300">
                    ...
                    <a href="/bottom" class="hover:text-black cursor-pointer transition-colors">
                        Bottoms
                    </a>
                ...
                <li class="relative pl-5 flex items-center gap-2 before:content-[''] before:absolute before:left-[7px] before:top-[-10px] before:bottom-2 before:w-[1px] before:bg-gray-300">
                    ...
                    <a href="/dresses" class="hover:text-black cursor-pointer transition-colors">
                        Dresses
                    </a>
                ...
                <li class="relative pl-5 flex items-center gap-2 before:content-[''] before:absolute before:left-[7px] before:top-[-10px] before:bottom-2 before:w-[1px] before:bg-gray-300">
                    ...
                    <a href="/outerwear" class="hover:text-black cursor-pointer transition-colors">
                        Outerwear
                    </a>
                ...
                <li class="relative pl-5 flex items-center gap-2 before:content-[''] before:absolute before:left-[7px] before:top-[-10px] before:bottom-2 before:w-[1px] before:bg-gray-300">
                    ...
                    <a href="/activewear" class="hover:text-black cursor-pointer transition-colors">
                        Activewear
                    </a>
            ...
            <div class="flex justify-end mb-10">
                ...
                <div class="relative w-72">
                    ...
                    <input
                        type="text"
                        placeholder="Search"
                        class="w-full bg-[#F3F4F6] border border-gray-200 rounded-full pl-12 pr-5 py-2.5 text-sm outline-none"
                    >
                ...
                <div class="flex flex-col">
                    ...
                    <div class="relative bg-[#EAEAEA] aspect-[4/5] rounded-[30px] mb-4 overflow-hidden shadow-sm">
                        ...
                        <button
                            ...
                            class="absolute top-5 right-5 z-20 outline-none"
                        >
                    ...
                    <div class="flex gap-2 mt-4">
                        ...
                        <form action="/cart/add" method="POST" class="flex-1">
                            ...
                            <button
                                type="submit"
                                class="w-full border border-black rounded-full py-2 text-[10px] font-bold hover:bg-black hover:text-white transition-all cursor-pointer"
                            >
                                Add to cart
                            </button>
